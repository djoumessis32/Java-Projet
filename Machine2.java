...
public class Machine2 implements ActionListener {
	...
	Machine2(JButton lebtn, ImageIcon[] letab, int imageType) {
	...
	public static void main(String[] args) {
		...
		lebtn1.addActionListener(new Machine2(lebtn1, TABIMAGES1, 1));
		lebtn2.addActionListener(new Machine2(lebtn2, TABIMAGES2, 2));
		lebtn3.addActionListener(new Machine2(lebtn3, TABIMAGES3, 3));
		lebtn4.addActionListener(new Machine2(lebtn4, TABIMAGES4, 4));
    ...
    void Envoi(int compteur) {
		...
		try {
			...
			destinationPort = Integer.parseInt("300");
    ...
    private static void Reception(JButton[] tabBtns, ImageIcon[][] tabsIcon) {
		...
		while(true) {
			try {
				localPort = Integer.parseInt("400");  
